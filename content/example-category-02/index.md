...
A similar category is [[content/example-category-01/index|Category 01]], which also uses the `index.md` method to specify a category page title and descriptive text.